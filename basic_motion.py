...
while True:
    try:
        ...
        if throttle_input <= 1.0:
            ...
            car.throttle = float(0.2)
            break
            print("Throttle value must be less than or equal to 1.0")
    except ValueError:
    ...
    try:
        ...
        print("Invalid input. Please enter a valid floating-point number.")
#    car.steering = float(input("Steering"))
#    if car.steering == 100.0:
#        break
